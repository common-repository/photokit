jQuery(document).ready(function ($) {
	$("#wp-media-grid").prepend('<a data-padding-bottom="95vh" href="' + WPURLS.siteurl + '/photokit" dataimgsrc="https://cdn.pixabay.com/photo/2020/04/20/04/02/brick-5066282_960_720.jpg" class="iframe-lightbox-link"  target="_blank"><i class="fa fa-wordpress" aria-hidden="true"></i>Edit image with photokit</a>');
	$(".edit-attachment").prepend('<a data-padding-bottom="95vh" href="https://store.payproglobal.com/r?u=https%3A%2F%2Fphotokit.com%2Feditor%2F%3Flang%3Den&a=xxxx" dataimgsrc="https://cdn.pixabay.com/photo/2020/04/20/04/02/brick-5066282_960_720.jpg" class="iframe-lightbox-link"  target="_blank"><i class="fa fa-wordpress" aria-hidden="true"></i>Edit image with photokit</a>');
...
(function (root, document) {
	...
	[].forEach.call(document.getElementsByClassName("iframe-lightbox-link"), function (el) {
		...
		el.lightbox = new IframeLightbox(el, {
			...
			onLoaded: function () {
				/* hide your preloader */
				var photokit = document.getElementById(el.lightbox.iframeId)
				...
				*/
				console.log(el)
				console.log(el.getAttribute("dataimgsrc"))
				toDataURL(el.getAttribute("dataimgsrc"),
					function (dataUrl) {
				...
				window.addEventListener("message", function (event) {
					// In postMessage mode, monitor the saved image data.
					if (event.data.type == "photokitsdk" && event.data.name == "saveimage") {

						document.getElementById('demo').setAttribute("src", event.data.imagedata);
						document.getElementById('demo').setAttribute("alt", event.data.imagename);
